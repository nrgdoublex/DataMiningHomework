...
with open("Q2vi_data.txt",'w') as f:
    f.write("%f\n" % pulp_mean)

print("pulp mean completed")
...
predict = [round_to_05(i+pulp_mean) for i in rating[train_num:]]
...
df_output.to_csv("Q2vi_predict.csv",index=False)

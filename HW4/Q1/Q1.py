...
print("indices of a1 with large value = %s" %np.where(A[0] > 0.001))
print("indices of a2 with large value = %s" %np.where(A[1] > 0.001))
print("indices of b1 with large value = %s" %np.where(B[0] > 0.001))
print("indices of b2 with large value = %s" %np.where(B[1] > 0.001))
print("indices of c1 with large value = %s" %np.where(C[0] > 0.001))
print("indices of c2 with large value = %s" %np.where(C[1] > 0.001))
print('\n')

print("indices of a1 with nonzero value = %s" %np.where(A[0] > 0.001))
print("indices of b1 with nonzero value = %s" %np.where(B[0] > 0.001))
print("indices of c1 with nonzero value = %s" %np.where(C[0] > 0.001))
pl.figure()
pl.plot(A[0,])
pl.xlabel("index of component")
pl.ylabel("value of component")
pl.title("Vector a1")
pl.savefig("a1.png")
